...
- این کاربر به دنبال افزایش کارایی در ورزش خاص یا آمادگی جسمانی سطح بالا است.
- برای ورزشکاران حرفه‌ای: از تکنیک‌های پیشرفته (مانند پلایومتریک، توان انفجاری، و دوره‌بندی غیرخطی) استفاده کنید.
- برای مبتدیان/سالمندان: ابتدا بر ایجاد پایه قوی هوازی و قدرت عمومی تمرکز کنید تا از آسیب جلوگیری شود. ایمنی در اولویت است.
- اولویت با حرکات چندمفصله و کاربردی (Functional) است که مستقیماً به عملکرد ورزشی انتقال می‌یابند.
- در فازبندی، دوره‌های اوج‌گیری (Peaking) و کاهش فشار (Tapering) را برای مسابقات یا رویدادهای احتمالی در نظر بگیرید.
""",
            'body_recomposition': """
**دستورالعمل ویژه برای تمرکز: بهبود فرم بدن (Body Recomposition)**
- هدف اصلی کاهش چربی همزمان با حفظ یا ساخت عضله است.
- ترکیب تمرینات مقاومتی (برای حفظ عضله) و تمرینات متابولیک/اینتروال (برای چربی‌سوزی) ضروری است.
- حجم تمرین باید کافی باشد تا هایپرتروفی تحریک شود، اما نه آنقدر زیاد که ریکاوری در شرایط کمبود کالری احتمالی مختل شود.
- برای افراد مسن/مبتدی: از وزنه‌های سبک‌تر با تکرار کنترل شده استفاده کنید و بر فرم صحیح تمرکز کنید. فشار بیش از حد ممنوع است.
- برای حرفه‌ای‌ها: از تکنیک‌های شدت‌دهنده مانند دراپ‌ست یا سوپرست برای افزایش تراکم تمرین استفاده کنید.
""",
            'efficiency': """
**دستورالعمل ویژه برای تمرکز: کارایی و کمبود وقت (Efficiency)**
- کاربر وقت محدودی دارد، بنابراین "بازدهی به ازای زمان" حیاتی است.
- از سیستم‌های تمرینی با تراکم بالا مانند تمرینات دایره‌ای (Circuit)، سوپرست‌ها (Supersets) و EMOM استفاده کنید.
- تمرکز بر حرکات ترکیبی (Compound) که بیشترین عضلات را در کمترین زمان درگیر می‌کنند (مانند اسکوات، ددلیفت، پرس‌ها).
- زمان استراحت بین ست‌ها را به حداقل برسانید تا ضربان قلب بالا بماند.
- برای همه سطوح: برنامه باید در زمان کوتاه (مثلاً ۳۰-۴۵ دقیقه) قابل اجرا باشد اما شدت کافی برای ایجاد سازگاری را داشته باشد.
""",
            'rebuilding_rehab': """
**دستورالعمل ویژه برای تمرکز: بازسازی و ریکاوری (Rebuilding/Rehab)**
- ایمنی و سلامت مفاصل اولویت مطلق است. برنامه باید "بدون درد" و "ایمن" باشد.
- تمرکز بر اصلاح عدم تعادل عضلانی، بهبود دامنه حرکتی (Mobility) و ثبات مرکزی (Core Stability).
- برای سالمندان/مبتدیان: حرکات با وزن بدن، استفاده از ماشین‌ها برای ایمنی بیشتر، و تمرکز بر تعادل و هماهنگی عصب و عضله.
- برای ورزشکاران آسیب‌دیده: تمرینات ایزومتریک و اکسنتریک کنترل شده برای تقویت تاندون‌ها و لیگامان‌ها.
- از حرکات پرخطر یا با ضربه بالا (High Impact) اجتناب کنید. پیشرفت باید بسیار تدریجی و محافظه‌کارانه باشد.
"""
        }
        ...
        system_instructions = f"""شما یک استراتژیست حرفه‌ای تناسب اندام و مربی ورزشی با سال‌ها تجربه هستید.
